...
urlpatterns = [
    ...
    path('borrar_evento/<int:evento_id>/', views.borrar_evento, name='borrar_evento'),
    path('borrar_participante/<int:participante_id>/', views.borrar_participante, name='borrar_participante'),
]